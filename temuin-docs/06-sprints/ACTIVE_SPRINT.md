...
- **Active Sprint**: `sprint-08`
- **Periode**: Minggu 16 (UAS)
- **Alignment Modul**: Modul 15 (Security, Cleanup & Dokumentasi)
...
|--------|--------|-------|-----------|
| 13 | sprint-05 | 9-10 | CI 3-job, ruff, pytest cov ≥60%, vitest cov ≥40%, branch protection doc |
...
| 16 (now) | sprint-08 | 15 | Security hardening, image non-root, security headers, release v1.0.0 |
...
2. Buka sprint berikutnya (jika ada backlog/sprint baru)
